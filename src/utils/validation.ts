...
export const FormSubmitActionSchema = z.object({
  ...
  formFallbackSelectors: z.array(z.string()).optional(),
  fields: z.array(FieldSpecSchema),
  submitSelector: z.string(),
  submitFallbackSelectors: z.array(z.string()).optional(),
...
export const ClickFlowActionSchema = z.object({
  ...
  startFallbackSelectors: z.array(z.string()).optional(),
  intermediateSteps: z.array(z.string()).optional(),
  intermediateFallbackSelectors: z.array(z.array(z.string())).optional(),
